...
public class WithOperationASTTransformation extends AbstractASTTransformation {
  ...
  public void visit(ASTNode[] nodes, SourceUnit source) {
    ...
    if (parent instanceof ClassNode) {
      ...
      String name = getMemberStringValue(annotation, "name");
      ClassNode opClass = getMemberClassValue(annotation, "implementation");
      boolean isStatic = Optional.ofNullable(getMemberValue(annotation, "isStatic")).map(Boolean.class::cast).orElse(false);
      makeMethods(clazz, name, opClass, isStatic);
    }
  }

  private void makeMethods(ClassNode targetClass, String opName, ClassNode opClass, boolean isStatic) {
